          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              {state.history.map((item, index) => (
                <Card
                  key={item.id}
                  className="bg-slate-800/40 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/50 transition-all duration-200"
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <Badge
                          className={getProbabilityColor(item.probability)}
                        >
                      ...
                      <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
                        <CardContent className="p-4 text-center">
                          ...
                          <p className="text-xl font-bold text-green-400">
                            {((1 - item.results[0].probability) * 100).toFixed(
                              1
                            )}
                            %
                          </p>
                      ...
                      <Card className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border-amber-500/20">
                        <CardContent className="p-4 text-center">
                          ...
                          <p className="text-xl font-bold text-amber-400">
                            {(() => {
                              const maxResult = item.results.reduce(
                                (max, current) =>
                                  current.probability > max.probability
                                    ? current
                                    : max
                              );
